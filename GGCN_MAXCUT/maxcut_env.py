...
class maxcut_env:
    def __init__(self, number_nodes_min, number_nodes_max, p=0.5, replay_penalty=-1000):
    ...
    def is_done(self):
        ...
        if self.action_count +1 >= self.real_nodes:
            done = True
        return done
    ...
    def step(self, action):
        ...
        return self.state,self.node_feat, rew, self.is_done(), self.adjacency_matrix, self.weight_matrix,self.adjust_matrix,self.edge_feat,self.aux(self.state)
